...
{
    [Test]
    [Arguments(0, false, "$0.00")]
    [Arguments(0, true, "$0")]
    [Arguments(1234.56, false, "$1,234.56")]
    [Arguments(1234.56, true, "$1,235")]
    [Arguments(1234, false, "$1,234.00")]
    [Arguments(1234, true, "$1,234")]
    [Arguments(0.99, false, "$0.99")]
    [Arguments(0.99, true, "$1")]
    [Arguments(-1234.56, false, "-$1,234.56")]
    [Arguments(-1234.56, true, "-$1,235")]
    [Arguments(-0.99, false, "-$0.99")]
    [Arguments(-0.99, true, "-$1")]
    [Arguments(1000000, false, "$1,000,000.00")]
    [Arguments(1000000, true, "$1,000,000")]
